...
namespace OpenAPIWithAuth.Logging
{
    ...
    public class RequestResponseLoggingMiddleware
    {
        ...
        private void LogToFile(string message)
        {
            ...
            // Temporarily remove the read-only attribute if it exists
            ...
            File.AppendAllText(_logFilePath, $"{formattedTime}: {message}{Environment.NewLine}");

            // Reapply the read-only attribute after writing
            if (fileInfo.Exists)
            {
